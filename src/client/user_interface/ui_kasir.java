 ...
 * @author user
 */
public class ui_kasir extends javax.swing.JFrame {
    ...
    public ui_kasir() {
        initComponents();
        ImageIcon ico = new ImageIcon((getClass().getResource("/image/cashbox.png")));
    ...
    private void get_attribute() {
        ...
        lca.load();
        if (Integer.parseInt(lca.category()) == 3 || Integer.parseInt(lca.category()) == 4) {
    ...
    private void initComponents() {
        ...
        logo_ksr1 = new template.logo_ksr();
        ...
        logo_ksr1.setPreferredSize(new java.awt.Dimension(50, 50));

        javax.swing.GroupLayout logo_ksr1Layout = new javax.swing.GroupLayout(logo_ksr1);
        logo_ksr1.setLayout(logo_ksr1Layout);
        logo_ksr1Layout.setHorizontalGroup(
            logo_ksr1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 82, Short.MAX_VALUE)
        );
        logo_ksr1Layout.setVerticalGroup(
            logo_ksr1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panel_b1Layout.setHorizontalGroup(
            ...
            .addGroup(panel_b1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(logo_ksr1, javax.swing.GroupLayout.PREFERRED_SIZE, 82, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(panel_b1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
        ...
        panel_b1Layout.setVerticalGroup(
            ...
            .addGroup(panel_b1Layout.createSequentialGroup()
                ...
                .addGroup(panel_b1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(logo_ksr1, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(panel_b1Layout.createSequentialGroup()
        ...
        antrian.setText("<html> <tr style='border-bottom:1pt'> <td>K-SPP</td> <td>: 0</td> </tr> <tr style='border-bottom:1pt'> <td>K-Setoran</td> <td>: 0</td> </tr> <tr style='border-bottom:1pt'> <td>K-Tab./T-Angs.</td> <td>: 0</td></html>");
        ...
        panel_a1Layout.setHorizontalGroup(
            ...
            .addGroup(panel_a1Layout.createSequentialGroup()
                .addGap(3, 3, 3)
                .addComponent(antrian, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
                .addGap(3, 3, 3))
        );
        ...
        buttonGroup1.add(spp);
        spp.setFont(new java.awt.Font("Cambria Math", 1, 12)); // NOI18N
        ...
        panel_a3Layout.setHorizontalGroup(
            ...
            .addGroup(panel_a3Layout.createSequentialGroup()
                .addGap(3, 3, 3)
                .addComponent(nomor, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
                .addGap(3, 3, 3))
        );
        ...
        senyap.setMnemonic('e');
        senyap.setToolTipText("<html><b>[Alt + e]</b> Senyap</html>");
        ...
        jLabel7.setText("<html>S<u>e</u>nyap</html>");
        ...
        panel_b6.setBackground(new java.awt.Color(102, 255, 204));
        ...
        tb_ulang.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/appbar.reply.people.png"))); // NOI18N
        tb_ulang.setMnemonic('U');
        tb_ulang.setToolTipText("<html><b>[Alt + U]</b> Ulang</html>");
        ...
        jLabel4.setText("<html><u>U</u>lang</html>");
        ...
        panel_a5Layout.setHorizontalGroup(
            ...
            .addGroup(panel_a5Layout.createSequentialGroup()
                ...
                .addGroup(panel_a5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(tb_ulang, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        if (kategori.getSelectedIndex() == 3 || kategori.getSelectedIndex() == 4) {
            set_attribute();
        } else {
            JOptionPane.showMessageDialog(this, "<html>Aplikasi ini hanya untuk kategori <b><u>" + kategori.getItemAt(3) + "/" + kategori.getItemAt(4) + "</u></b></html>", "Failed", JOptionPane.PLAIN_MESSAGE);
            kategori.requestFocus();
        }
    ...
    private void mulaiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mulaiActionPerformed
        if ("Mulai".equals(mulai.getText())) {
            try {
                ...
                if (bl == false) {
                    if (crl.lookup() != null) {
                        crl.registry(antrian, null, 4, ip, nomeja.getSelectedIndex() + 1);
                        ...
                        sa.get_client_list_cashier(antrian);
                        last_number();
                        five.transferFocus();
                    } else {
                ...
                Logger.getLogger(ui_kasir.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            ua.set_counter(get_data_attribute(mulai.getText()));
    ...
    private void last_number() {
        ArrayList<String> nomor_antrian = sa.get_end_number(kategori.getSelectedIndex() + 1, 5, Integer.parseInt(nomeja.getSelectedItem().toString()));
        ...
        if (evt.getKeyCode() == evt.VK_ENTER) {
            if ("Mulai".equals(mulai.getText())) {
                try {
                    ...
                    if (bl == false) {
                        if (crl.lookup() != null) {
                            crl.registry(antrian, null, 0, ip, nomeja.getSelectedIndex() + 1);
                            ua.connection(con.connection());
                            ua.set_counter(get_data_attribute(mulai.getText()));
                            mulai("Berhenti", "/image/off - Copy.png", 'e', "<html><b>[Alt + e]</b> Berhenti</html>", true);
                            sa.get_client_list_cashier(antrian);
        ...
        public void run() {
            try {
                ...
                for (int i = 0; i < jumlah; i++) {
                    String nomor_antrian = iss.get_number(kategori.getSelectedIndex() + 1, kode);
                    if (nomor_antrian != null) {
                        ...
                        iss.end_number(nomor_antrian, id_antrian, 5, Integer.parseInt(nomeja.getSelectedItem().toString()));
                        String nama_kategori = null;
                        if (nomor_antrian.substring(0, 1).equals("1")) {
                            nama_kategori = "SPP Kasir";
                        } else if (nomor_antrian.substring(0, 1).equals("3")) {
                            nama_kategori = "Setoran Kasir";
                        } else if (nomor_antrian.substring(0, 1).equals("5")) {
                            nama_kategori = "Tab./T-Angs Kasir";
                        }
                        iss.call_number(nama_kategori, nomor_antrian, kategori.getSelectedIndex() + 1, Integer.parseInt(nomeja.getSelectedItem().toString()), inisial_button);
                        // lookup display
                    } else {
        ...
        public void run() {
            try {
                ...
                for (int i = 0; i < rows.length; i++) {
                    ...
                    nomor.setText(table1.getValueAt(rows[i], 0).toString());
                    String nama_kategori = null;
                    if (table1.getValueAt(rows[i], 0).toString().substring(0, 1).equals("1")) {
                        nama_kategori = "SPP Kasir";
                    } else if (table1.getValueAt(rows[i], 0).toString().equals("3")) {
                        nama_kategori = "Setoran Kasir";
                    } else if (table1.getValueAt(rows[i], 0).toString().equals("5")) {
                        nama_kategori = "Tab./T-Angs Kasir";
                    }
                    iss.call_number(nama_kategori, table1.getValueAt(rows[i], 0).toString(), kategori.getSelectedIndex() + 1, Integer.parseInt(nomeja.getSelectedItem().toString()), 1);
                    // lookup display
                }
                mulai.setEnabled(true);
                mulai.setEnabled(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ui_kasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private template.logo_ksr logo_ksr1;
